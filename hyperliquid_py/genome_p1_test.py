...
def map_genome_to_phenotype(genome, start_symbol='Rule'):
    def expand(symbol, depth=0):
        ...
        if depth > 10:
            ...
            return "self.data.Close[-1] > self.data.Open[-1]" if symbol == 'Condition' else ""
        ...
        if not genome:
            ...
            if symbol == 'Condition':
                ...
                return f"{indicator1} {comparison_op} {indicator2}"  # DÜZELTİLMİŞ SATIR
            else:
